...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(6).withKI(0).withKD(2)
        .withKS(0.1).withKV(0).withKA(0)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClos edLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(10).withKI(4).withKD(10)
    ...
    private static final Current kSlipCurrent = Amps.of(13);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.017822265625);
