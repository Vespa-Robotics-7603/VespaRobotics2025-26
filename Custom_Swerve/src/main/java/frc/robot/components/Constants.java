...
public class Constants {
    ...
    // common constants
    public static final double OFFSET = 0.350; // how far the wheels have to spin to be more correct, only really used in swervemodule
    public static final byte PORT = 0; // the usb port of the controlelr
    public static final double STICK_DEADZONE_POSITIVE = 0.15;
    public static final double STICK_DEADZONE_NEGATIVE = -0.15;
    public static final double TRIGGER_DEADZONE = 0.15; // no negative
